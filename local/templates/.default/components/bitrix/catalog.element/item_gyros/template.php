...
?>
    ...
    <div class="bx-catalog-element<?= $themeClass ?> col-12" id="<?= $itemIds['ID'] ?>" itemscope
        ...
        <div class="row">
            <img src="<?= $arResult['PREVIEW_PICTURE']['SRC'] ?>" class="productpicture" alt="">
            <p class="productname">
                <?= $arResult['NAME'] ?>
            </p>
            ...
            <div class="<?= ($haveOffers ? "col-12" : "col-12"); ?>">
                <div class="row">
                    <?
                    if ($haveOffers) {
                        ?>
                                                                                            ...
                                                                                            <li class="product-item-scu-item-color-container"
                                                                                                ...
                                                                                                data-onevalue="<?= $value['ID'] ?>">
                                                                                                            <span class="product-item-scu-item-color-block">
                                                                                                                <span class="product-item-scu-item-color"
                                                                                                                      title="<?= $value['NAME'] ?>"
                    ...
                    ?>
                    <div class="<?= ($haveOffers ? "col-lg-12" : "col-lg"); ?>">
                        <div class="row">
                            <div class="product-item-detail-pay-block col-12">
                                <div class="row">
                                    <?
                                    foreach ($arParams['PRODUCT_PAY_BLOCK_ORDER'] as $blockName) {
                                        switch ($blockName) {
                                                    ...
                                                    <div class="productprice">
                                                        ...
                                                        if ($arParams['SHOW_OLD_PRICE'] === 'Y') {
                                                            ...
                                                            <div class="product-item-detail-price-old mb-1"
                                                                ...
                                                                <?= ($showDiscount ? '' : 'style="display: none;"') ?>><?= ($showDiscount ? $price['RATIO_BASE_PRICE'] : '') ?>
                                                                ₽
                                                            </div>
                                                            <?
                                                        }
                                                        ...
                                                        <div class="product-item-detail-price-current mb-1"
                                                             id="<?= $itemIds['PRICE_ID'] ?>"><?= $price['RATIO_PRICE'] ?>
                                                            ₽
                                                        </div>
                                                        ...
                                                        if ($arParams['SHOW_OLD_PRICE'] === 'Y') {
                                                            ...
                                                            <div class="product-item-detail-economy-price mb-1"
                                                                ...
                                                                if ($showDiscount) {
                                                                    echo Loc::getMessage('CT_BCE_CATALOG_ECONOMY_INFO2', array('#ECONOMY#' => $price['RATIO_DISCOUNT']));
                                                                }
                                                                ?> ₽
                                                            </div>
                                                            <?
                                                                ...
                                                                if ($showRanges) {
																	...
																	<span class="product-item-detail-properties-name text-muted">
                                                                        ...
                                                                        ?>
                                                                                    ...
                                                                                    <span class="product-item-detail-properties-dots"></span>
                                                                                    <span class="product-item-detail-properties-value"><?= ($useRatio ? $itemPrice['RATIO_PRICE'] : $itemPrice['RATIO_PRICE']) ?>
                                                                                        ₽</span>
                                                                                </li>
                                                                                <?
                                                                            }
                                                ...
                                                if ($arParams['SHOW_MAX_QUANTITY'] !== 'N') {
                                                    if ($haveOffers) {
                                                        ...
                                                        if (
                                                            ...
                                                            <span class="product-item-detail-info-container-title"><?= $arParams['MESS_SHOW_MAX_QUANTITY'] ?>
                                                                :</span>
                                                                <span class="product-item-quantity"
                                            ...
                                            case 'buttons':
                                                ?>
                                                <div data-entity="main-button-container" class="mb-3 col-5">
                                                    <div id="<?= $itemIds['BASKET_ACTIONS_ID'] ?>"
                                                        ...
                                                        if ($showAddBtn) {
                                                            ?>
                                                            <div class="mb-3">
                                                                <a class="btn <?= $showButtonClassName ?> btn-danger tocard product-item-detail-buy-button"
                                                        ...
                                                        if ($showBuyBtn) {
                                                            ?>
                                                            <div class="mb-3">
                                                                <a class="btn <?= $buyButtonClassName ?> btn-danger tocard product-item-detail-buy-button"
                                                                   id="<?= $itemIds['BUY_LINK'] ?>"
                                                                   href="javascript:void(0);">
                                                ...
                                                <div class="mb-3" id="<?= $itemIds['NOT_AVAILABLE_MESS'] ?>"
                                                     style="display: <?= (!$actualItem['CAN_BUY'] ? '' : 'none') ?>;">
                                                    <a class="btn btn-danger tocard product-item-detail-buy-button"
                                                       href="javascript:void(0)"
        ...
        <div class="p-2 product-item-detail-short-card-fixed d-none d-md-block"
             id="<?= $itemIds['SMALL_CARD_PANEL_ID'] ?>" style="display:none;">
            <div class="product-item-detail-short-card-content-container" style="display:none;">
                ...
                <div class="product-item-detail-short-card-price">
                    ...
                    if ($arParams['SHOW_OLD_PRICE'] === 'Y') {
                        ...
                        <div class="product-item-detail-price-old"
                            ...
                            <?= ($showDiscount ? $price['RATIO_BASE_PRICE'] : '') ?>
                        </div>
                        <?
                    }
                    ?>
                    <div class="product-item-detail-price-current"
                         data-entity="panel-price"><?= $price['RATIO_PRICE'] ?> ₽
                    </div>
                </div>
                <?
                if ($showAddBtn) {
                ...
                <div class="product-item-detail-short-card-btn"
                    ...
                    <a class="btn btn-link btn-danger tocard product-item-detail-buy-button"
                       href="javascript:void(0)"
                       rel="nofollow">
        ...
        <div class="pt-2 pb-0 product-item-detail-tabs-container-fixed d-none d-md-block"
             id="<?= $itemIds['TABS_PANEL_ID'] ?>" style="display:none;">
            <ul class="product-item-detail-tabs-list">
                <?
                if ($showDescription) {
                    ?>
                    ...
                    foreach ($jsOffer['ITEM_QUANTITY_RANGES'] as $range) {
                        if ($range['HASH'] !== 'ZERO-INF') {
                            ...
                            if ($itemPrice) {
                                ...
                                $strPriceRanges .= '</dt><dd>' . ($useRatio ? $itemPrice['RATIO_PRICE'] : $itemPrice['RATIO_PRICE']) . '</dd>';
                            }
                        }
                    }
